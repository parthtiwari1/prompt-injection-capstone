# attacks/run_gemini.py
# =============================================================
# WHAT THIS DOES:
# Runs all 5 attack types against Gemini Flash model
# using the free Google AI API.
# =============================================================
...
def run_attacks():
    print("=" * 60)
    print("  ALL ATTACKS — GEMINI FLASH")
    print("  Target: SafeBank Customer Service Chatbot")
    print("  Model:  Gemini 1.5 Flash (Google AI API)")
    print("=" * 60)
    ...
    for attack in ALL_ATTACKS:
        ...
        response = ask_gemini(attack["prompt"])
    ...
    with open("results/gemini_attack_results.json", "w") as f:
        json.dump({
    ...
    print("\n  Results saved to: results/gemini_attack_results.json")
    return results, asr
